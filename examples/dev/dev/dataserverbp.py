...
# 数据格式为float32小端在前
# headstr + eegarray
# headstr: srate + eegchNum + 0/1, 分别对应采样率，eeg信号通道，是否包含trigger
# eegarray: float32字节序列（小端在前），按照如下顺序排列[ch1,ch2,..chn](采样点1)，[ch1,ch2,..chn](采样点2)...
# 有trigger通道时，trigger在通道最后

class DataServer():
    _update_interval = 0.04
...
if __name__ == '__main__':
    param = {'devName':'BP','srate':250,'devAddr':'127.0.0.1','devPort':51244,'mqAddr':'127.0.0.1','mqPort':1883,'topic':'/bcios/eeg'}
